...
<script setup>
import { ref } from 'vue';
import CrewProfile from '../CrewProfile/CrewProfile.vue';
...
let crewMember = ref(crew[0]);
let active = ref(0);

function changeActive(index) {
  active.value = index;
  crewMember.value = crew[index];
}
</script>
